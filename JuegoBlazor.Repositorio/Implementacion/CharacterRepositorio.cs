...
{
    public class CharacterRepositorio : GenericoRepositorio<Character>, ICharacterRepositorio
    {
        private readonly L2testGame2Context _dbContext;

        public CharacterRepositorio(L2testGame2Context dbContext) : base(dbContext)
        {
